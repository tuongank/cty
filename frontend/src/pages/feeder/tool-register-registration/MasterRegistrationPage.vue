...
import CategoryMasterCard from 'components/tool-feeder/CategoryMasterCard.vue'
import TypeMasterCard from 'components/tool-feeder/TypeMasterCard.vue'
import RegistryDatabaseCard from 'components/tool-feeder/RegistryDatabaseCard.vue'
import CategoryFormDialog from 'components/tool-feeder/CategoryFormDialog.vue'
import TypeFormDialog from 'components/tool-feeder/TypeFormDialog.vue'
import RegisterToolDialog from 'components/tool-feeder/RegisterToolDialog.vue'
import ConfirmDeleteDialog from 'components/tool-feeder/ConfirmDeleteDialog.vue'
